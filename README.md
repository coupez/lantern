...
Matter DNS-SD discovery recognizes commissionable, commissioner, and operational advertisements. Reported names and 65 protocol type labels can identify categories such as lights, locks, sensors, and appliances. Vendor/product IDs remain source-linked claims without guessing a retail model or manufacturer. No pairing is required; physical-device and Thread forwarding coverage remain unverified. See [recognition details](docs/recognition.md).

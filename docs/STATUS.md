...
1. Expand identification: stronger evidence-based device/model classification; mDNS follow-up queries; SSDP descriptions; broader protocol fingerprints with documented sources. No claim of mapping everything.

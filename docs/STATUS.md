...
- Matter DNS-SD recognition across commissionable, commissioner, and operational services, with advertised names/IDs and 65 pinned Apache-2.0 device-type labels. Split-reply IPv4/IPv6 fixtures cover all three roles; physical devices, Thread forwarding, and vendor/product-name catalogs remain pending.
